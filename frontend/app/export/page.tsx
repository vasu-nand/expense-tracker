    ...
    return (
        <div className="space-y-6">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                    <h1 className="text-3xl font-bold bg-gradient-to-r from-teal-400 to-teal-600 bg-clip-text text-transparent flex items-center gap-2">
                        <FileText className="h-8 w-8 text-teal-500" /> Export PDF Report
                    </h1>
                    <p className="text-muted-foreground mt-1">Configure filters and export dynamic expense statements with security watermarks.</p>
                </div>
                <Link href="/dashboard">
            ...
            {!loading && !error && transactions.length > 0 && (
                <div className="space-y-4">
                    <div className="flex justify-between items-center px-2">
                        <span className="text-sm font-semibold text-muted-foreground">Document Print Preview ({chunkedTransactions.length + 1} pages)</span>
                        <span className="text-xs text-muted-foreground">Watermark (Logo_BG_Rmv.png) is active</span>
                    </div>

                    <div className="flex flex-col items-center gap-8 bg-zinc-900 border border-zinc-800 py-10 rounded-2xl overflow-y-auto max-h-[800px] shadow-inner select-none">
                        ...
                        <div ref={reportRef} className="flex flex-col gap-10 bg-zinc-900 text-zinc-950 p-2">
                            ...
                            <div className="pdf-page relative w-[210mm] h-[297mm] bg-white border shadow-2xl p-[20mm] flex flex-col justify-between overflow-hidden select-none flex-shrink-0">
                                ...
                                <div className="z-10 grid grid-cols-2 gap-4 my-4">
                                    ...
                                    <div className="border border-zinc-200 rounded-lg p-4 bg-zinc-50">
                                        <p className="text-xs text-zinc-500 font-semibold uppercase">Total Database Entries</p>
                                        <p className="text-2xl font-black text-teal-800 mt-1">
                                            {analytics?.totalEntries || 0}
                                        </p>
                                        <p className="text-[10px] text-zinc-400 mt-1">Total database load count</p>
                                    </div>
                                </div>
                                ...
                                <div className="z-10 border-t border-zinc-200 pt-4 flex justify-between text-[9px] text-zinc-400 font-mono">
                                    ...
                                    <span>Page 1 of {chunkedTransactions.length + 1}</span>
                                </div>
                            </div>
                            ...
                            <div className="pdf-page relative w-[210mm] h-[297mm] bg-white border shadow-2xl p-[20mm] flex flex-col justify-between overflow-hidden select-none flex-shrink-0">
                                ...
                                <div className="z-10 border-t border-zinc-200 pt-4 flex justify-between text-[9px] text-zinc-400 font-mono font-bold">
                                    ...
                                    <span>Page 2 of {chunkedTransactions.length + 1}</span>
                                </div>
                            </div>
