...
export function TopSpendingChart({ data }: TopSpendingChartProps) {
    ...
    const sortedData = [...convertedData].sort((a, b) => b.total - a.total).slice(0, 7);
                ...
                <ResponsiveContainer width="100%" height="100%">
                    <BarChart data={sortedData} margin={{ top: 20, right: 10, left: 10, bottom: 10 }}>
                        ...
                        <Tooltip
                            ...
                            formatter={(value: number) => [`${symbol}${value.toFixed(2)}`, 'Total Spending']}
                        ...
                        <Bar
                            ...
                            radius={[6, 6, 0, 0]}
                            maxBarSize={45}
                            stroke="var(--btn-gradient-end, rgb(13, 148, 136))"
                            strokeWidth={1}
                        >
