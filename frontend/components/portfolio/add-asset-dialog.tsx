...
import { X, TrendingUp, ChevronDown, Check } from 'lucide-react'
...
const ASSET_TYPES = [
    ...
    { value: 'fixed_deposits', label: 'Fixed Deposits (FD)' },
    { value: 'retirement_plans', label: 'Retirement Plans (EPF/PPF/NPS)' },
    { value: 'savings_accounts', label: 'Savings & Cash' }
]
...
export function AddAssetDialog({ isOpen, onClose, onSuccess }: AddAssetDialogProps) {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        if (!symbol.trim() || !name.trim()) {
            setError('Please provide asset symbol and name')
            return
        }
            ...
            <div className="relative w-full max-w-md bg-card border border-border rounded-2xl shadow-2xl flex flex-col max-h-[85vh] overflow-hidden">
                ...
                <div className="flex items-center justify-between p-4 sm:p-5 border-b border-border/60 bg-card shrink-0 z-10">
                    <div className="flex items-center space-x-2">
                        ...
                        <h2 className="text-lg font-extrabold text-foreground">Add Investment Asset</h2>
                    </div>
                ...
                <form onSubmit={handleSubmit} className="flex flex-col flex-1 overflow-hidden">
                    ...
                    >
                        ...
                        <div className="grid grid-cols-2 gap-3">
                            <div>
                                ...
                                <input
                                    ref={inputRef}
                                    type="text"
                                    placeholder="e.g. IRB, RELIANCE, AAPL"
                                    value={symbol}
                                    onChange={(e) => {
                        ...
                        <div>
                            <label className="text-xs font-bold text-muted-foreground block mb-1">Asset Name *</label>
                            <input
                                type="text"
                        ...
                        <div className="grid grid-cols-2 gap-3">
                            <div>
                                <label className="text-xs font-bold text-muted-foreground block mb-1">Asset Class *</label>
                                <BottomSelect
                                    value={assetType}
                            ...
                            <div>
                                <label className="text-xs font-bold text-muted-foreground block mb-1">Exchange</label>
                                <input
                                    type="text"
