...
import { CreateAccountDialog } from './navigation/create-account-dialog'
...
export function Navigation() {
    ...
    return (
        <nav className="border-b sticky top-0 z-50 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
                    ...
                    <div className="flex items-center space-x-6">
                        ...
                        {mounted && (
                            <div className="relative" ref={switcherRef}>
                                ...
                                {switcherOpen && (
                                    <div className="absolute -left-20 md:left-0 mt-2 w-64 rounded-2xl bg-white dark:bg-zinc-900 border border-border/95 shadow-[0_15px_30px_rgba(0,0,0,0.15)] dark:shadow-[0_15px_30px_rgba(0,0,0,0.5)] p-2 z-50 animate-in fade-in slide-in-from-top-2 duration-200">
            ...
            <CreateAccountDialog isOpen={isCreateOpen} onClose={() => setIsCreateOpen(false)} />
        </nav>
    )
}